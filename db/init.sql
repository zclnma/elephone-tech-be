...
create table transaction_move_path (transaction_id uuid not null, move_path_id uuid not null, move_path_order int4 not null, primary key (transaction_id, move_path_order));
...
alter table if exists transaction_move_path add constraint UK_6b4ahm7hbuxwwrpw1bysw218c unique (move_path_id);
...
alter table if exists transaction_move_path add constraint FKcdye1i1hty6l2ow436myug6n5 foreign key (move_path_id) references store;
alter table if exists transaction_move_path add constraint FKm05149ibx7byu6o28itdxxpd9 foreign key (transaction_id) references transaction;
