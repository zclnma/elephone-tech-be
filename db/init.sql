...
create table employee (id uuid not null, birthday varchar(255), contact varchar(255), created_date timestamp, email varchar(255), first_name varchar(255), gender int4, last_modified_date timestamp, last_name varchar(255), tfn varchar(255), primary key (id))
