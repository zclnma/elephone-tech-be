...
public class StoreResource {
    ...
    @Autowired
    public StoreResource(TransactionService transactionService, IncomeService incomeService, WorkHistoryService workHistoryService, EmployeeService employeeService, final StoreService storeService, final StoreDTOMapper storeDTOMapper) {
