package com.elephone.management.utils;
...
public class OkHttpCli {
    ...
    private OkHttpClient okHttpClient = new OkHttpClient.Builder().retryOnConnectionFailure(true).connectTimeout(30, TimeUnit.SECONDS).build();
    /**
     * get 请求
     * @param url  请求url地址
     * @return string
