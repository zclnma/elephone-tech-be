...
create table store (id uuid not null, abn varchar(255), contact varchar(255), created_date int8 not null, last_modified_date int8 not null, role int4, sequence varchar(255), warranty int4, primary key (id))
