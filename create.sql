...
create table transaction (id uuid not null, addition_info varchar(255), battery varchar(255), color varchar(255), product_condition varchar(255), contact varchar(255), created_date timestamp, customer_name varchar(255), device varchar(255), email varchar(255), finalised_time varchar(255), imei varchar(255), is_deleted boolean, is_finalised boolean, issue TEXT, last_modified_date timestamp, passcode varchar(255), pickup_time varchar(255), resolution varchar(255), signature TEXT, status int4, transaction_number varchar(255), created_by uuid, finalised_by uuid, init_store_id uuid, store_id uuid, primary key (id))
create table transaction_inspections (transaction_id uuid not null, inspections int4)
create table transaction_products (transaction_id uuid not null, description varchar(255), number varchar(255), price varchar(255))
alter table if exists store add constraint UK_d0p5ly1cv6guij7sq1mbnr8ec unique (name)
alter table if exists store add constraint UK_gy2t1kmdqvne04o8xxb9c7chc unique (sequence)
