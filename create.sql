...
create table income (id uuid not null, cash int4, created_date timestamp, efpos int4, last_modified_date timestamp, employee_id uuid, store_id uuid not null, primary key (id))
create table store (id uuid not null, abn varchar(255), address varchar(255), contact varchar(255), created_date timestamp, email varchar(255), is_deleted boolean, last_modified_date timestamp, name varchar(255), sequence varchar(255), transaction_number int4, warranty int4, primary key (id))
create table transaction (id uuid not null, addition_info varchar(255), battery varchar(255), color varchar(255), product_condition varchar(255), contact varchar(255), created_date timestamp, customer_name varchar(255), deposit varchar(255), device varchar(255), email varchar(255), finalised_time timestamp, imei varchar(255), is_deleted boolean, issue TEXT, last_modified_date timestamp, passcode varchar(255), pickup_time varchar(255), resolution varchar(255), signature TEXT, status int4, transaction_number varchar(255), created_by uuid, finalised_by uuid, init_store_id uuid, store_id uuid, primary key (id))
create table transaction_inspections (transaction_id uuid not null, inspections int4)
create table transaction_products (transaction_id uuid not null, description varchar(255), number varchar(255), price varchar(255))
create table warranty_history (id uuid not null, created_date timestamp, description varchar(255), last_modified_date timestamp, employee_id uuid not null, store_id uuid not null, transaction_id uuid not null, primary key (id))
alter table if exists store add constraint UK_d0p5ly1cv6guij7sq1mbnr8ec unique (name)
...
create table employee_store (employee_id uuid not null, store_id uuid not null)
create table income (id uuid not null, cash int4, created_date timestamp, efpos int4, last_modified_date timestamp, employee_id uuid, store_id uuid not null, primary key (id))
create table store (id uuid not null, abn varchar(255), address varchar(255), contact varchar(255), created_date timestamp, email varchar(255), is_deleted boolean, last_modified_date timestamp, name varchar(255), reference int4, sequence varchar(255), warranty int4, primary key (id))
...
create table transaction (id uuid not null, addition_info varchar(255), auth_signature TEXT, battery varchar(255), color varchar(255), product_condition varchar(255), conf_signature TEXT, contact varchar(255), created_date timestamp, customer_name varchar(255), deposit varchar(255), device varchar(255), email varchar(255), finalised_time timestamp, imei varchar(255), is_deleted boolean, issue TEXT, last_modified_date timestamp, passcode varchar(255), pickup_time varchar(255), reference varchar(255), resolution varchar(255), status int4, created_by uuid, finalised_by uuid, init_store_id uuid, store_id uuid, primary key (id))
create table transaction_inspections (transaction_id uuid not null, inspections int4)
create table transaction_products (transaction_id uuid not null, description varchar(255), number varchar(255), price varchar(255))
create table warranty_history (id uuid not null, created_date timestamp, description varchar(255), last_modified_date timestamp, employee_id uuid not null, store_id uuid not null, transaction_id uuid not null, primary key (id))
alter table if exists employee_stores add constraint UK_beripoopjvqmf3o7uu0n33hly unique (stores_id)
